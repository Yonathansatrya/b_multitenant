...
<body class="bg-gray-100 flex items-center justify-center h-screen">
    <div class="bg-white p-8 rounded-lg shadow-lg max-w-md text-center">
        <h2 class="text-2xl font-bold text-gray-800">Undangan Bergabung ke {{ $invitation->organization->name }}</h2>
        ...
        @else
            ...
            <form action="{{ route('invite.cancel', $invitation->invite_code) }}" method="POST" class="mt-2">
                @csrf
